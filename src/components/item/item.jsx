...
export class Item extends Component {
    ...
    onTouchEnd = (event) => {
        ...
        event.preventDefault();
        const itemInfo = {itemId: item._id, containerId: containerId, index: index};
    ...
    isSelected = () => {
        return this.props.snapshotDnd.selectedItems.some(x => x.itemId === this.props.item._id);
    }

    isGhosting = (isCardSelected) => {
        return this.props.snapshotDnd.draggingItemId && this.props.snapshotDnd.draggingItemId !== this.props.item._id && isCardSelected;
    }
